...
func MainPage(w http.ResponseWriter, r *http.Request) {
	...
	pageStruct.PageName = "Main Admin Page"

	webutils.RenderTemplate(w, []string{"pkg/web/adminPanel/templates/main.html", "pkg/web/adminPanel/templates/head.html", "pkg/web/adminPanel/templates/sidebar.html", "pkg/web/adminPanel/templates/footer.html"}, pageStruct)
