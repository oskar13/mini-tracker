...
func GetUserGroupsList(userID int, visibility string) []webdata.GroupListObject {
	var groupList []webdata.GroupListObject
	...
	defer rows.Close()
	for rows.Next() {
		var listItem webdata.GroupListObject
...
func ListPublicGroups() []webdata.GroupListObject {
	var groupList []webdata.GroupListObject
